...
@CrossOrigin(value = "http://localhost:3000")//peticiones desde frontend
public class EmpleadoControlador {
    ...
    @GetMapping("/empleados")//Leer empleado
    ...
    @PostMapping("/empleados")//Agregar empleados
    ...
    public ResponseEntity<Empleado> actulaizarEmpleado(@PathVariable Integer id, @RequestBody Empleado empleadoRecibido){
        Empleado empleado = empleadoServicio.buscarEmpleadoPorId(id);
        if (empleado == null)
